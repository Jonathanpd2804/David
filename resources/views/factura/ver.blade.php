...
$fecha = $_GET['fecha'];
echo("<h1>COMPROBAR FACTURA</h1>");
echo("</br>");
echo("<form action='download/factura' method='get' id='formulario'>");
...
echo("El número de factura es: <input type='text' id='numero' name='numero' value='{$numero}'>");
echo("</br>");
